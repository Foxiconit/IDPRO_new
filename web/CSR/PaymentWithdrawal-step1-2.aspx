<%@ Page Title="" Language="C#" MasterPageFile="~/web/CSR/CustomerService.Master" AutoEventWireup="true"
    CodeBehind="PaymentWithdrawal-step1-2.aspx.cs" Inherits="IDPRO.PaymentWithdrawal_step1_2" %>
                        ...
                        <div class="span11">
                            <div class="span8 cs">
                                <blockquote class="example-right">
                                    <p>
                                        Mr. Customer, you drafted these funds in to give your negotiator leverage to negotiate
                                        settlements on your behalf. Withdrawing funds severely hampers our ability to reach
                                        settlements, and get you out of debt. We strongly advise against this.
                                    </p>
                                </blockquote>
                            </div>
                        </div>
