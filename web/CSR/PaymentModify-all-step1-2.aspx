<%@ Page Title="" Language="C#" MasterPageFile="~/web/CSR/CustomerService.Master" AutoEventWireup="true"
    CodeBehind="PaymentModify-all-step1-2.aspx.cs" Inherits="IDPRO.PaymentModify_all_step1_2" %>
                        ...
                        <div class="span11">
                            <div class="span8 cs">
                                <blockquote class="example-right">
                                    <p>
                                        Mr. Customer, how would you like to modify your drafts?
                                    </p>
                                </blockquote>
                            </div>
                        </div>
                                    ...
                                    <div class="span12">
                                        <div class="control-group">
                                            <asp:RadioButtonList ID="rdb" runat="server" CssClass="radio inline" RepeatDirection="Vertical">
                                                <asp:ListItem Text="Dates" Selected="True" Value="1" />
                                                <asp:ListItem Text="Frequency" Value="2" />
