<%@ Page Title="" Language="C#" MasterPageFile="~/web/CSR/CustomerService.Master" AutoEventWireup="true"
    CodeBehind="PaymentModify-step11-1.aspx.cs" Inherits="IDPRO.web.CSR.PaymentModify_step11_1" %>
                        ...
                        <div class="span5">
                            <div class="span10 cs">
                                <blockquote class="example-right">
                                    <p>
                                        Which draft do you need to push?
                                    </p>
                                </blockquote>
                            </div>
                                    ...
                                    <div class="row-fluid">
                                        <asp:Panel ID="pnlpayment" runat="server" Visible="false">
                                            <div class="span10 cs">
                                                <blockquote class="example-right">
                                                    <p>
                                                        And which date would you like to push it to?
                                                    </p>
                                                </blockquote>
                                            </div>
                                        </asp:Panel>
